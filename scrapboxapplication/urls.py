...
urlpatterns = [
    ...
    path('scrapbox/<int:pk>/addtocart', views.AddToWishListView.as_view(), name="addtocart"),
    ...
    path('scrap/<int:pk>/buy',views.ShippingView.as_view(),name="shipping"),
    path('scrap/<int:pk>/orderplaced',views.OrderPlacedView.as_view(),name="orderplaced"),
    path('add/<int:product_id>/', views.add_to_cart, name='add_to_cart'),
